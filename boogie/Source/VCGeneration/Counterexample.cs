...
namespace Microsoft.Boogie
{
  ...
  public abstract class Counterexample
  {
    ...
    internal Counterexample(VCGenOptions options, List<Cmd> assumedCmds, List<Block> trace, List<object> augmentedTrace, Model model,
      VC.ModelViewInfo mvInfo, ProverContext context, ProofRun proofRun)
    {
      Contract.Requires(trace != null);
      Contract.Requires(context != null);
  ...
  public class AssertCounterexample : Counterexample
  {
    ...
    public AssertCounterexample(VCGenOptions options, List<Cmd> assumedCmds, List<Block> trace, List<object> augmentedTrace, AssertCmd failingAssert, Model model, VC.ModelViewInfo mvInfo,
      ProverContext context, ProofRun proofRun)
      : base(options, assumedCmds, trace, augmentedTrace, model, mvInfo, context, proofRun)
    {
      Contract.Requires(trace != null);
      Contract.Requires(failingAssert != null);
    ...
    {
      var ret = new AssertCounterexample(options, AssumedCmds, Trace, AugmentedTrace, FailingAssert, Model, MvInfo, Context, ProofRun);
  ...
  public class CallCounterexample : Counterexample
  {
    ...
    public CallCounterexample(VCGenOptions options,  List<Cmd> assumedCmds, List<Block> trace, List<object> augmentedTrace, AssertRequiresCmd assertRequiresCmd, Model model,
      VC.ModelViewInfo mvInfo, ProverContext context, ProofRun proofRun, byte[] checksum = null)
      : base(options, assumedCmds, trace, augmentedTrace, model, mvInfo, context, proofRun)
    {
      var failingRequires = assertRequiresCmd.Requires;
    ...
    public override Counterexample Clone()
    {
      var ret = new CallCounterexample(options, AssumedCmds, Trace, AugmentedTrace, FailingAssert, Model, MvInfo, Context, ProofRun, Checksum);
      ret.calleeCounterexamples = calleeCounterexamples;
      return ret;
    }
  }
  ...
  public class ReturnCounterexample : Counterexample
  {
    ...
    public ReturnCounterexample(VCGenOptions options, List<Cmd> assumedCmds, List<Block> trace, List<object> augmentedTrace, AssertEnsuresCmd assertEnsuresCmd, TransferCmd failingReturn, Model model,
      VC.ModelViewInfo mvInfo, ProverContext context, ProofRun proofRun, byte[] checksum)
      : base(options, assumedCmds, trace, augmentedTrace, model, mvInfo, context, proofRun)
    {
      var failingEnsures = assertEnsuresCmd.Ensures;
    ...
    public override Counterexample Clone()
    {
      var ret = new ReturnCounterexample(options, AssumedCmds, Trace, AugmentedTrace, FailingAssert, FailingReturn, Model, MvInfo, Context, ProofRun, checksum);
      ret.calleeCounterexamples = calleeCounterexamples;
      return ret;
    }
  }
  ...
  public class VerifierCallback
  {
    ...
    public async virtual Task OnCounterexample(Counterexample ce, string /*?*/ reason)
    {
      Contract.Requires(ce != null);
    }
